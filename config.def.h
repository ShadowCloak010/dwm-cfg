...
static const char *fonts[]          = { "Hack Nerd Font:style=Regular:size=13", "WenQuanYi Micro Hei:size=13"};
static const char dmenufont[]       = "Hack Nerd Font:style=Regular:size=13";
